...
st.markdown('<div class="main-title"> VisionaryIQ </div>', unsafe_allow_html=True)
st.markdown('<div class="subtitle"> ✯ An AI Solution for Visually Impaired ✯ </div>', unsafe_allow_html=True)

# Sidebar Features
st.sidebar.image(
    r"C:\Users\Mohith varma\Downloads\eye.jpeg",
    width=250
)
...
st.markdown(
    ...
    <footer style="text-align:left;">
        <p>Powered by <strong>Google Gemini API ⛓️‍💥</strong> | Harsha Vardhini Pendyala </p>
    </footer>
    """,
    unsafe_allow_html=True,
)
